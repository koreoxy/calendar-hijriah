...
export const CalenderHijriahPage = () => {
  ...
  return (
    <div className="">
      <section
        className="flex flex-col lg:flex-row justify-between gap-5 max-w-7xl mx-auto mb-20 md:py-16 md:px-32"
        id="calender"
      >
        <div className="flex flex-col p-5 w-full text-center md:text-start">
          <h1 className="font-bold text-4xl font-pacifico">
            <b className="text-rose-600">Calendar</b> Hijriah
          </h1>
          <p className="mt-5 text-2xl font-medium">
            Web tools untuk konversi kalender masehi ke kalender hijriah, Bahasa
            Arab dan Bahasa Aceh.
          </p>

          <div className="relative hidden md:block">
            <Card className="w-full mt-10 p-5 static">
              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                ...
                <Card className="p-2 w-full col-span-full">
                  <h1 className="font-bold">Bahasa Indonesia :</h1>
                  {isLoading ? (
                    ...
                    <div>
                      {hijriDate && (
                        <div>
                          ...
                          <p>
                            Bulan :{" "}
                            {bulanHijriahIndo[hijriDate.month.number - 1]}
                          </p>
                    ...
                    <div>
                      {hijriDate && (
                        <div>
                          ...
                          <p>
                            Buleuen : {bulanAceh[hijriDate.month.number - 1]}
                          </p>
            ...
            <img
              src="/try.png"
              className="w-[160px] h-[100px] absolute top-0 right-[-20px]"
            />
          </div>
        </div>

        <div className="w-full">
          <h1 className="font-bold text-2xl text-center">Kalender Masehi</h1>
          <Card className="flex flex-col mx-auto gap-5 p-0 sm:p-2 md:p-5 mt-2">
            ...
            <Card className="w-full h-full mt-1 p-5 block md:hidden">
              <div>
                <CalenderInput onSelectDate={handleDateSelect} />
              </div>
              <h1 className="font-bold text-xl mt-4 text-center">
