  ...
  return (
    <div className="">
      <section className="w-full h-[250px] md:h-[500px]">
        <div className="w-full h-[100%] bg-[url(/bulan.jpg)] bg-no-repeat bg-cover bg-center relative">
          <div className="bg-gray-800/50 w-full h-full">
            <div className="text-center mx-auto py-16 md:py-36 xl:py-40 max-w-sm md:max-w-3xl">
              <h1 className="text-white font-bold text-xl md:text-4xl">
                Seulayan Project
              </h1>
              <p className="mt-1 md:mt-5 text-white text-sm md:text-lg">
                Project ini dibuat untuk menggambarkan dan perhitungan kalender
                Hijriah dari Hisab bulan qamariyah dalam paparannya Oman
                Fathurohman menyebutkan, hisab awal bulan qamariyah adalah
                perhitungan tentang posisi bulan yang menandakan awal bulan
                qamariyah.
              </p>
            </div>
          </div>
